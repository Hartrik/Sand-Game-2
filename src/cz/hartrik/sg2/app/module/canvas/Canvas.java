...
public class Canvas {
    ...
    public Canvas(ScrollPane scrollPane, ImageView imageView) {
    ...
    public int getMinBounds() { return minBounds; }
    ...
    public void setMinBounds(int minBounds) { this.minBounds = minBounds; }
    ...
    public void update() {
        ...
        final double imageWidth  = imageView.getFitWidth();
        final double imageHeight = imageView.getFitHeight();
        ...
        imageView.relocate(xLocation, yLocation);
