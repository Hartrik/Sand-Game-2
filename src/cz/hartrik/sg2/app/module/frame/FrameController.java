...
import cz.hartrik.sg2.engine.JFXEngineT;
import cz.hartrik.sg2.engine.JFXRenderer;
import cz.hartrik.sg2.engine.JFXRendererBlur;
import cz.hartrik.sg2.process.ParallelProcessor;
import cz.hartrik.sg2.process.BasicProcessor;
...
public class FrameController extends FrameControllerTemplate implements Initializable {
    ...
    private JFXEngine<? extends BasicProcessor> engine;
    
    public JFXEngine<? extends BasicProcessor> getEngine() {
        return engine;
    }
    ...
    protected void setUpCanvas(ModularWorld world, int width, int height) {
        ...
        engine = new JFXEngineT<>(world, new ParallelProcessor(world,
                new ToolsWBrushManager(world, brushManager)), renderer, imageView);
