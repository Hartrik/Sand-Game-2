...
public class EditServices {
    ...
    public static final String SERVICE_EDIT_FLIP_V = "flip-vertically";
    public static final String SERVICE_EDIT_FLIP_H = "flip-horizontally";
    public static final String SERVICE_EDIT_ROTATE_L = "rotate-left";
    public static final String SERVICE_EDIT_ROTATE_R = "rotate-right";
