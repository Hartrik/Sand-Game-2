...
public abstract class FluidWater extends Fluid {
    ...
    protected boolean flow(final int x, final int y, GravityTools tools,
            ...
            if (world.valid(x2, y)) {
                ...
                if (second instanceof Air || second instanceof Fluid) {
                    ...
                    return (world.valid(x3, y)
                            && tools.move(x, y, this, x3, y, world.get(x3, y)))
                                || (tools.move(x, y, this, x2, y, second)
                                    || tools.move(x, y, this, x1, y, first));
                } else
                    return tools.move(x, y, this, x1, y, first);
            } else
                return tools.move(x, y, this, x1, y, first);
        } 
