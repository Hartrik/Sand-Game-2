...
/**
 * Abstraktní třída pro kapaliny, které přenášejí teplo.
 * 
 * @version 2014-08-18
 * @author Patrik Harag
 */
public abstract class FluidWaterTC extends FluidWater
        implements ThermalConductiveDef {
    
    private static final long serialVersionUID = 83715083867368_02_063L;

    private int temperature;
    
    public FluidWaterTC(Color color, int density) {
        this(color, density, NORMAL_TEMP);
    }
    
    public FluidWaterTC(Color color, int density, int temperature) {
        super(color, density);
