...
public class ApplicationBuilder {
    ...
    private static void loadRequiredServiceProviders(Set<Class<?>> requiredProviders, ServiceManager serviceManager)
            throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {

        for (Class<?> provider : requiredProviders) {
            Object newInstance = provider.getDeclaredConstructor().newInstance();
